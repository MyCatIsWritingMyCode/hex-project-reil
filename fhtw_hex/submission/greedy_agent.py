...
class GreedyAgent:
    def __init__(self):
        ...
        self.connection_weight = 1.0    # How much we value connecting our pieces
        self.blocking_weight = 0.8      # How much we value blocking opponent
        self.distance_weight = 0.5      # How much we value distance to opponent's path
